		 ...
		 <div class="grid bigGapBott"> 
				...
				<div class="unit one-third">
					<p class="mediumGapTopPad">
						...
						Seeing the countryside you can kind of understand why NASA astronats like Neil Armstrong trained here.  I mean, why even bother going to the moon really Neil?  The same shit is here, fool.
					</p>					
				</div>	
				<div class="unit two-thirds">
					<img class="mediumGapBott" src="../../../../assets/iceland/IMG_3891.jpg"/>
